...
public class Frame {
	...
	static final int FLAG_START_IDX = 0;
	static final int FLAG_END_IDX = 507;
	static final int ID_IDX = 1;
	static final int CONTROL_IDX = 2;
	static final int INFORMATION_IDX = 3;
	static final int FCS_IDX = 503;
